...
#ifdef OS_WIN_STORE
const WCHAR AppUserModelIdBase[] = L"Kangram.KangramDesktop.Store";
#else // OS_WIN_STORE
const WCHAR AppUserModelIdBase[] = L"Kangram.KangramDesktop";
#endif // OS_WIN_STORE
...
void CleanupShortcut() {
	...
	QString path = systemShortcutPath() + u"Kangram.lnk"_q;
...
bool checkInstalled(QString path = {}) {
	...
	const auto installed = u"Kangram Desktop/Kangram.lnk"_q;
	const auto old = u"Kangram for Windows/Kangram.lnk"_q;
